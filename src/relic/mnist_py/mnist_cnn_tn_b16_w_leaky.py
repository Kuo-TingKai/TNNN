...
for width in [16,81,256,625] :    
    #print(num_classes)
    #print(y_train)
    
    # define model
    model = Sequential()
    model.add( Conv2DMPO(width, kernel_size=3, input_shape=(28, 28, 1), num_nodes=4, bond_dim=16)) # 256 feature maps, 3x3 local receptive fields
    ...
    np.save('history_b16_leak01_w'+str(width)+'.npy',history.history)
